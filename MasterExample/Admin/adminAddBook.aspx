...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
   ...
   <ul>
       <li>
            ...
            <asp:Button ID="btnHome" runat="server" Text="Admin Main Page" CssClass="roundcornerTwo" BackColor="#009999"  CausesValidation="False"/>
       </li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="auto-style2">
        ...
        <ul style="margin-left:200px">
            ...
            <li>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtBookIsbn" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                <br />
            </li>
            ...
            <li>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtBookQuantity" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                <br />
            </li>

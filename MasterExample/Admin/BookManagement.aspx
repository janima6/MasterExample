    ...
    <asp:Label ID="Label2" runat="server" Text="All Added Books" Font-Size="X-Large" ForeColor="White" Font-Bold="True"></asp:Label>&nbsp;
        ...
        <asp:Button ID="searchByCode" runat="server" Text="Search By Book Code" />
            ...
            <p>
              ...
              <asp:GridView ID="grdAllBooks" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="grdAllBooks_SelectedIndexChanged" Width="1000px"  style="margin:auto;">
